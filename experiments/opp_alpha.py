...
for cfg in CFG:
    ...
    for s in (0,1,2):
        ...
        for al in ALPHAS:
            g=_A.certify_action(_A.fit_action_score(P[fit], tf, (1-b)*Pt[fit]+b*tf, y[fit], loss), P[conf], tc, cc, y[conf], P[test], tt, loss, al, DELTA, fit=(P[fit], tf, (1-b)*Pt[fit]+b*tf, y[fit])); ap=g['apply']
