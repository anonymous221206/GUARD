#!/usr/bin/env python3
"""Turn every ``results/*/guard.csv`` into the tables that appear in the paper.

Numbers in the paper are generated by this script, never typed by hand, so a
figure in the text can always be traced to the run directory that produced it.
"""
